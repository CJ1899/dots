...
//	{ MODKEY,                  XK_g,      spawn, {.v = (const char*[]){ "gedit", NULL } } },
	{ MODKEY,                  XK_g,      spawn, {.v = (const char*[]){ "qbittorrent", NULL } } },
        { MODKEY,                  XK_c,      (void (*)(const Arg *))wall_cycle, {.i = +1} },
        { MODKEY,                  XK_x,      (void (*)(const Arg *))wall_cycle, {.i = -1} },
        { MODKEY|SHIFT,            XK_s,      (void (*)(const Arg *))wall_save,  {0} },
        { MODKEY|CONTROL|SHIFT,    XK_c,      (void (*)(const Arg *))wall_random,  {0} },
        { MODKEY,                  XK_s,      (void (*)(const Arg *))wall_select,  {0} },
        { MODKEY,                  XK_r,      (void (*)(const Arg *))wall_reload,  {0} },
        { MODKEY|SHIFT,            XK_c,      (void (*)(const Arg *))wall_folder_select, {.i = +1} },
        { MODKEY|SHIFT,            XK_x,      (void (*)(const Arg *))wall_folder_select, {.i = -1} },
