...
//	{ MODKEY,                  XK_s,      spawn, {.v = (const char*[]){ "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", black, "-nf", gray3, "-sb", blue, "-sf", gray4, NULL } } },
	...
	{ MODKEY,                  XK_c,      spawn, {.v = (const char*[]){ "wl", "next", NULL } } },
	{ MODKEY,                  XK_x,      spawn, {.v = (const char*[]){ "wl", "prev", NULL } } },
	{ MODKEY|SHIFT,            XK_s,      spawn, {.v = (const char*[]){ "wl", "save", NULL } } },
	{ MODKEY|CONTROL|SHIFT,    XK_c,      spawn, {.v = (const char*[]){ "wl", "rand", NULL } } },
	{ MODKEY,                  XK_s,      spawn, {.v = (const char*[]){ "wl", "menu", NULL } } },
	{ MODKEY|SHIFT,            XK_c,      spawn, {.v = (const char*[]){ "wl", "fnext", NULL } } },
	{ MODKEY|SHIFT,            XK_x,      spawn, {.v = (const char*[]){ "wl", "fprev", NULL } } },
	{ MODKEY,                  XK_r,      spawn, {.v = (const char*[]){ "wl", "reload", NULL } } },
	{ MODKEY,                  XK_m,      spawn, {.v = (const char*[]){ "/home/pc/src/scripts/s2", NULL } } },
	{ MODKEY,                  XK_Home,   spawn, {.v = (const char*[]){ "layout", NULL } } },


	{ 0,                       XF86XK_MonBrightnessUp,     spawn, {.v = (const char*[]){ "backlight", "up", NULL } } },
	{ MODKEY|SHIFT,            XF86XK_MonBrightnessUp,     spawn, {.v = (const char*[]){ "xbacklight", "+1", NULL } } },
        ...
        { 0,                       XF86XK_MonBrightnessDown,   spawn, {.v = (const char*[]){ "backlight", "down", NULL } } },
...
/*	{ MODKEY,                  XF86XK_AudioMicMute,        spawn, {.v = (const char*[]){ "sudo", "shutdown", "now", NULL } } },
	...
	{ 0,                       XK_Print,        spawn, {.v = (const char*[]){ "/bin/sh", "-c", "maim \"$HOME/Pictures/$(date +%s).png\"", NULL } } },
	{ 0,                       XF86XK_Search,   spawn, {.v = (const char*[]){ TERMINAL, "iwctl", NULL } } },
